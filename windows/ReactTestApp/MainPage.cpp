...
namespace
{
    winrt::hstring const kDisableBreakOnFirstLine = L"Disable Break on First Line";
    winrt::hstring const kEnableBreakOnFirstLine = L"Enable Break on First Line";

    winrt::hstring const kDisableDirectDebugger = L"Disable Direct Debugging";
    winrt::hstring const kEnableDirectDebugger = L"Enable Direct Debugging";

    winrt::hstring const kDisableFastRefresh = L"Disable Fast Refresh";
    winrt::hstring const kEnableFastRefresh = L"Enable Fast Refresh";

    winrt::hstring const kDisableWebDebugger = L"Disable Remote JS Debugging";
    winrt::hstring const kEnableWebDebugger = L"Enable Remote JS Debugging";

    bool ToggleMenuItem(IInspectable const &sender,
                        winrt::hstring const &enableText,
                        winrt::hstring const &disableText)
    {
        auto item = sender.as<MenuFlyoutItem>();
        auto const isEnabled = item.Text() == enableText;
...
{
    auto const breakOnFirstLine =
        ToggleMenuItem(sender, kEnableBreakOnFirstLine, kDisableBreakOnFirstLine);
...
{
    auto const useDirectDebugger =
        ToggleMenuItem(sender, kEnableDirectDebugger, kDisableDirectDebugger);
...
{
    auto const useFastRefresh = ToggleMenuItem(sender, kEnableFastRefresh, kDisableFastRefresh);
...
{
    WebDebuggerMenuItem().Text(reactInstance_.UseWebDebugger() ? kDisableWebDebugger
                                                               : kEnableWebDebugger);

    DirectDebuggingMenuItem().Text(reactInstance_.UseDirectDebugger() ? kDisableDirectDebugger
                                                                      : kEnableDirectDebugger);

    BreakOnFirstLineMenuItem().Text(reactInstance_.BreakOnFirstLine() ? kDisableBreakOnFirstLine
                                                                      : kEnableBreakOnFirstLine);

    FastRefreshMenuItem().Text(reactInstance_.UseFastRefresh() ? kDisableFastRefresh
                                                               : kEnableFastRefresh);
}
